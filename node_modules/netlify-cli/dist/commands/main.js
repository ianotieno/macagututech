...
import { BANG, chalk, logAndThrowError, exit, log, NETLIFY_CYAN, USER_AGENT, warn, logError, } from '../utils/command-helpers.js';
...
process.on('uncaughtException', async (err) => {
    if ('code' in err && err.code === 'EADDRINUSE') {
        logError(`${chalk.red(`Port ${err.port} is already in use`)}\n\n` +
...
export const createMainCommand = () => {
    ...
    program
        ...
        return `→ For more help with the CLI, visit ${NETLIFY_CYAN(terminalLink(cliDocsEntrypointUrl, cliDocsEntrypointUrl))}
