...
const triggerDeploy = async ({ api, options, siteData, siteId, }) => {
    try {
        ...
        if (options.json) {
            ...
            log(`${NETLIFYDEVLOG} A new deployment was triggered successfully. Visit https://app.netlify.com/sites/${siteData.name}/deploys/${siteBuild.deploy_id} to see the logs.`);
        }
    }
    catch (error_) {
